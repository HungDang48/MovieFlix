                            ...
                            <div class="modal-body">
                                <div class="row mb-2">
                                    <div class="col">
                                        ...
                                        <input v-model="them_moi.ten_phim" type="text" class="form-control"
                                            placeholder="Nhập vào tên phim">
                                    </div>
                                    <div class="col">
                                        <label class="mb-2">Slug Phim</label>
                                        <input v-model="them_moi.slug_phim" type="text" class="form-control"
                                ...
                                <div class="row mb-2">
                                    <div class="col">
                                        ...
                                        <input v-model="them_moi.dien_vien" type="text" class="form-control"
                                            placeholder="Nhập vào danh sách diễn viên">
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        ...
                                        <input v-model="them_moi.ngon_ngu" type="text" class="form-control"
                                ...
                                <div class="row mb-2">
                                    <div class="col">
                                        ...
                                        <input v-model="them_moi.rated" type="text" class="form-control"
                                    ...
                                    <div class="col">
                                        ...
                                        <input v-model="them_moi.bat_dau" type="date" class="form-control"
                                            placeholder="Nhập vào số phút chiếu">
                                    </div>
                                    <div class="col">
                                        <label class="mb-2">Thời Gian Kết Thúc</label>
                                        <input v-model="them_moi.ket_thuc" type="date" class="form-control"
                                            placeholder="Nhập vào ngôn ngữ">
                                    </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <textarea id="mo_ta" name="mo_ta" class="form-control" cols="30" rows="5"
                                            placeholder="Nhập vào mô tả phim"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <div class="text-dark">Bạn có chắc chắn muốn xóa phim <b
                                                                class="text-danger">@{{ tt_xoa.ten_phim }}</b> này không!
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button v-on:click="xoaPhim()" type="button" class="btn btn-primary"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row mb-2">
                                                <div class="col">
                                                    <label class="mb-2">Tên Phim</label>
                                                    <input v-model="edit.ten_phim" type="text" class="form-control"
                                                        placeholder="Nhập vào tên phim">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Slug Phim</label>
                                                    <input v-model="edit.slug_phim" type="text" class="form-control"
                                                        placeholder="Nhập vào slug phim">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Hình Ảnh</label>
                                                ...
                                                <div class="col">
                                                    <label class="mb-2">Tên Đạo Diễn</label>
                                                    <input v-model="edit.dao_dien" type="text" class="form-control"
                                                        placeholder="Nhập vào danh sách đạo diễn">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col">
                                                    <label class="mb-2">Diễn Viên</label>
                                                    <input v-model="edit.dien_vien" type="text" class="form-control"
                                                        placeholder="Nhập vào danh sách diễn viên">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Thể Loại</label>
                                                    <input v-model="edit.the_loai" type="text" class="form-control"
                                                        placeholder="Nhập vào thể loại">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Thời Lượng Chiếu</label>
                                                    <input v-model="edit.thoi_luong" type="number" class="form-control"
                                                        placeholder="Nhập vào số phút chiếu">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Ngôn Ngữ</label>
                                                    <input v-model="edit.ngon_ngu" type="text" class="form-control"
                                                        placeholder="Nhập vào ngôn ngữ">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col">
                                                    <label class="mb-2">Rated</label>
                                                    <input v-model="edit.rated" type="text" class="form-control"
                                                        placeholder="Nhập vào Rated">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Link youtube</label>
                                                    <input v-model="edit.trailer" type="text" class="form-control"
                                                        placeholder="Nhập vào link youtube">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Thời Gian Bắt Đầu</label>
                                                    <input v-model="edit.bat_dau" type="date" class="form-control"
                                                        placeholder="Nhập vào số phút chiếu">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Thời Gian Kết Thúc</label>
                                                    <input v-model="edit.ket_thuc" type="date" class="form-control"
                                                        placeholder="Nhập vào ngôn ngữ">
                                                </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-9">
                                                    <label class="mb-2">Mô Tả</label>
                                                    <textarea id="e_mo_ta" name="mo_ta" class="form-control" cols="30" rows="5"
                                                        placeholder="Nhập vào mô tả phim"></textarea>
                                                </div>
                                            </div>
                                        </div>
