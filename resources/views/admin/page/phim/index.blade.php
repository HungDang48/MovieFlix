                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input id="dien_vien" type="text" class="form-control"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col">
                                    ...
                                    <input id="bat_dau" type="date" class="form-control"
                                        placeholder="Nhập vào số phút chiếu">
                                </div>
                                <div class="col">
                                    <label class="mb-2">Thời Gian Kết Thúc</label>
                                    <input id="ket_thuc" type="date" class="form-control"
                                        placeholder="Nhập vào ngôn ngữ">
                                </div>
                            </div>
                            <div class="row mb-2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <img class="rounded-circle p-1 border" width="90px" height="90px"
                                                src="https://w7.pngwing.com/pngs/431/803/png-transparent-rodimus-bumblebee-transformers-logo-autobot-transformers-s-sticker-transformers-prime-area.png"
                                                alt="">
                                        </td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <div class="text-dark">Bạn có chắc chắn muốn xóa phim <b
                                                            id="phim_xoa" class="text-danger">ABC</b> này không!</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            axios
                ...
                .then((res) => {
                    ...
                    $.each(data, function(k, v) {
                        ...
                        noi_dung += '<img class="rounded-circle p-1 border" width="90px" height="90px" src="' +
                            v.hinh_anh + '" alt="">';
                        noi_dung += '</td>';
                        ...
                        if (v.hien_thi == 1) {
                            noi_dung += '<button data-id="' + v.id +
                                '" class="btn btn-primary status">Hiển Thị</button>';
                        } else {
                            noi_dung += '<button data-id="' + v.id +
                                '" class="btn btn-warning status">Tạm Tắt </button>';
                        }
                        noi_dung += '</td>';
                        noi_dung += '<td class="text-nowrap align-middle text-center">';
                        noi_dung += '<button data-id="' + v.id +
                            '" class="edit btn btn-info m-1" data-bs-toggle="modal" data-bs-target="#editModal">Cập Nhật</button>';
                        noi_dung += '<button data-id="' + v.id +
                            '" class="del btn btn-danger" data-bs-toggle="modal" data-bs-target="#delModal">Hủy Bỏ</button>';
                        noi_dung += '</td>';
                        noi_dung += '</tr>';
                    });
